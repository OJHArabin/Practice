   ...
   private static ConnectionFactory secondConnectionFactory;
    public static void main(String args[])
    {
         try {
           ...
           connectionA=secondConnectionFactory.createConnection();
           sessionA=connectionA.createSession(false,Session.AUTO_ACKNOWLEDGE);
           messageConsumerA=sessionA.createConsumer(secondQueue);
    ...
    //   String message="110/5";
       try {
           ...
           messageProducer=session.createProducer(firstQueue);
       ...
       DataInputStream dis=new DataInputStream(System.in);
           while(true)
           {
               try
               {
                   System.out.println("Me(ChatClientt):\t");
